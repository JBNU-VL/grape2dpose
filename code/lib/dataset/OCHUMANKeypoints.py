...
import pycocotools
from .OCHUMANDataset import OchumanDataset

logger = logging.getLogger(__name__)

class OchumanKeypoints(OchumanDataset):
    ...
    def __getitem__(self, idx):
        ...
        offset, offset_weight, visibility_map = self.offset_generator(
            joints_list[0], area)

        return img, heatmap, mask, offset, offset_weight, visibility_map
