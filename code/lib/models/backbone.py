...
class Backbone(nn.Module):
    ...
    def __init__(self, cfg, **kwargs):
        ...
        self.stage2_cfg = cfg['MODEL']['SPEC']['STAGE2']
        ...
        self.stage3_cfg = cfg['MODEL']['SPEC']['STAGE3']
        ...
        self.stage4_cfg = cfg['MODEL']['SPEC']['STAGE4']
        ...
        self.pretrained_layers = cfg['MODEL']['SPEC']['PRETRAINED_LAYERS']
